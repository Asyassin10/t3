...
import { Checkbox } from '@/shadcnuicomponents/ui/checkbox'
import {
  Form,
  FormControl,
  FormDescription,
...
import { Switch } from '@/shadcnuicomponents/ui/switch'
...
export function NotificationsForm() {
  ...
  const notificationsFormSchema = z.object({
    type: z.enum(['all', 'mentions', 'none'], {
      required_error: get_required_exception(i18n.language, t("notification_type"))
    }),
