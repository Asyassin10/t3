...
import { get_invalid_data_exception, get_max_exception_string, get_min_exception_string, get_required_exception } from '@/lib/helpers/language_validation_helper'
...
export default function ProfileForm() {
  ...
  const profileFormSchema = z.object({
    username: z
      ...
      .max(30, {
        message: get_max_exception_string(i18n.language, t("name"), 30),
      }),
    email: z
      .string({
    ...
    bio: z.string({
      required_error: t("validation.string.empty", { field: t("bio") })
    }).max(160).min(4),
    urls: z
      .array(
        z.object({
          value: z.string({
            required_error: t("validation.string.empty", { field: t("link") })
          }).url({
            message: get_invalid_data_exception(i18n.language, t("link")),
          }),
        })
      )
      .optional(),
